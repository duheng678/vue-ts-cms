<template>
  <div class="overview">
    ...
    <sky-card title="技术栈">
      <sky-text-link :text-arrs="technologyStacks" />
      <sky-descriptions title="生产环境依赖" :column="2" :table-datas="dependencies" />
      <sky-descriptions title="开发环境依赖" :column="2" :table-datas="devDependencies" />
    </sky-card>
    <sky-card title="项目结构">
      <div class="c-left">
        <sky-code language="bash" :code="projectDir" />
      </div>
    </sky-card>
    <sky-card title="项目规范">
      <sky-descriptions
...
import SkyDescriptions from '@/base-ui/descriptions'
import SkyTextLink from '@/base-ui/text-link'
import SkyCode from '@/base-ui/code'
